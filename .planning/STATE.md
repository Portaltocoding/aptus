...
- **Banco mucho mayor: EN CURSO.** Objetivo ~250 (50/dim). Actual: **148/250**. Por dimensión: llm-rag-evals **55 ✓** (5 experto), ml-clasico **50 ✓** (5 experto), fullstack 15, ai-product 14, comportamental 14. Staff ya evaluable para AI/LLM/ML Engineer y AI Product. Faltan a 50 (con experto): **fullstack, ai-product, comportamental**. Escrito a mano, verificando correctitud; ids `<dim>-NNN`.
