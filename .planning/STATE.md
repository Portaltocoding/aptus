...
- **Banco mucho mayor: EN CURSO.** Objetivo ~250 (50/dim). Actual: **183/250**. Por dimensión: llm-rag-evals **55 ✓** (5 experto), ml-clasico **50 ✓** (5 experto), fullstack-next-nest-ts **50 ✓** (5 experto), ai-product 14, comportamental 14. Faltan a 50 (con experto): **ai-product-system-design, comportamental-star**. Escrito a mano, verificando correctitud; ids `<dim>-NNN`.
