...
- [ ] **ENG-04**: El motor es agnóstico del dominio: no contiene conocimiento hardcodeado; todo el contenido vive en el pack.
...
- [ ] **CONT-02**: Cada pregunta tiene: enunciado, opciones select, respuesta(s) correcta(s), explicación, y metadata (tema, subtema, dificultad, rol, fuente, fecha).
