...
const ROLES: RoleReadiness[] = [
  {
    ...
    nextLevelId: "senior",
    nextLevelLabel: "Senior-ready",
    blockers: [],
    byDifficulty: [
      { difficulty: "easy", answered: 4, correct: 4, accuracy: 1, adjusted: 0.85 },
      { difficulty: "medium", answered: 4, correct: 3, accuracy: 0.75, adjusted: 0.65 },
      { difficulty: "hard", answered: 2, correct: 1, accuracy: 0.5, adjusted: 0.416667 },
    ],
    byDimension: [
  ...
  },
  {
    ...
    nextLevelId: "junior",
    nextLevelLabel: "Junior-ready",
    blockers: [],
    byDifficulty: [
      { difficulty: "easy", answered: 3, correct: 1, accuracy: 1 / 3, adjusted: 0.3125 },
      { difficulty: "medium", answered: 2, correct: 0, accuracy: 0, adjusted: 0.0833333 },
      { difficulty: "hard", answered: 0, correct: 0, accuracy: 0, adjusted: 0.25 },
    ],
